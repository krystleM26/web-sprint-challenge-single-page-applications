...
A known as a hook that makes it easy to build route paths and link to various locations.

1. How would you explain form validation to someone who has never programmed before?

Validation is a way a user can put the necessary inputs while filling out the form. 

1. In 1-2 sentences, define end to end testing.

E2E simulates how a user would use an application from beginning to end
